          ...
          <div class="content">
            <form action="##">
              <div class="input-text clearFix">
                ...
                <p style="color:red;margin-left:37px;" class="error-msg">{{ errors.first('phone') }}</p>
              </div>
              <div class="input-text clearFix">
                <span class="pwd"></span>
                ...
                <p style="color:red;margin-left:37px;" class="error-msg">{{ errors.first('password') }}</p>
              </div>
